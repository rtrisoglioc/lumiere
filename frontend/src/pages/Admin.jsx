...
const TABS = ["overview", "plans", "users", "video"];
const TAB_LABEL = {
  overview: { en: "Overview", es: "Resumen" }, plans: { en: "Plans & Pricing", es: "Planes y Precios" },
  users: { en: "Users", es: "Usuarios" }, video: { en: "Video Jobs", es: "Jobs de Video" },
};
            ...
            {tab === "overview" && (
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4" data-testid="admin-overview">
                {[["Users", overview.users], ["Experiences", overview.experiences], ["Cuts", overview.cuts],
                  ["Video jobs", overview.video_jobs], ["Videos done", overview.video_done], ["Videos failed", overview.video_failed]].map(([label, val]) => (
